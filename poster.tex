...
\begin{block}{Generative Adversarial Networks}
    ...
    \begin{block}{Domain Adaptation with Reverse Gradient}
        \begin{itemize}
            ...
            which can be adapted to new domains.  

            \item $Y$-like network: the image is fed to the
    ...
    \begin{columns}[t]
        ...
        \begin{column}{\onecolwid} % The third column
            ...
            \begin{block}{{\Large Experiments on Aurora-4}}
                ...
                number of noise conditions used for training. Average performance on seen versus 
